...
class Melcloud extends utils.Adapter {
	...
	constructor(options) {
		...
		// MELCloud intermediate certificate (see lib/melcloud_intermediate.pem), needed as otherwise requests will fail with "Unable to verify the first certificate"
