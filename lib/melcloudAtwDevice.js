	...
	async UpdateDeviceData(deviceOption) {
		...
		switch (deviceOption) {
			...
			case commonDefines.AtwDeviceOptions.SetHeatFlowTemperatureZone1:
				await gthat.setStateChangedAsync(controlPrefix + commonDefines.AtwDeviceStateIDs.SetHeatFlowTemperatureZone1, this.setHeatFlowTemperatureZone1, true);
				break;
			case commonDefines.AtwDeviceOptions.SetHeatFlowTemperatureZone2:
				if (this.hasZone2) await gthat.setStateChangedAsync(controlPrefix + commonDefines.AtwDeviceStateIDs.SetHeatFlowTemperatureZone2, this.setHeatFlowTemperatureZone2, true);
				break;
			case commonDefines.AtwDeviceOptions.SetCoolFlowTemperatureZone1:
				await gthat.setStateChangedAsync(controlPrefix + commonDefines.AtwDeviceStateIDs.SetCoolFlowTemperatureZone1, this.setCoolFlowTemperatureZone1, true);
				break;
			case commonDefines.AtwDeviceOptions.SetCoolFlowTemperatureZone2:
				if (this.hasZone2) await gthat.setStateChangedAsync(controlPrefix + commonDefines.AtwDeviceStateIDs.SetCoolFlowTemperatureZone2, this.setCoolFlowTemperatureZone2, true);
				break;
				...
				if (!response) {
					...
					switch (deviceOption) {
						...
						case commonDefines.AtwDeviceOptions.SetTemperatureZone2:
							...
							break;
						case commonDefines.AtwDeviceOptions.SetHeatFlowTemperatureZone1:
							gthis.setHeatFlowTemperatureZone1 = responseData.SetHeatFlowTemperatureZone1;
							break;
						case commonDefines.AtwDeviceOptions.SetHeatFlowTemperatureZone2:
							if (gthis.hasZone2) gthis.setHeatFlowTemperatureZone2 = responseData.SetHeatFlowTemperatureZone2;
							break;
						case commonDefines.AtwDeviceOptions.SetCoolFlowTemperatureZone1:
							gthis.setCoolFlowTemperatureZone1 = responseData.SetCoolFlowTemperatureZone1;
							break;
						case commonDefines.AtwDeviceOptions.SetCoolFlowTemperatureZone2:
							if (gthis.hasZone2) gthis.setCoolFlowTemperatureZone2 = responseData.SetCoolFlowTemperatureZone2;
							break;
						default:
							break;
					}
