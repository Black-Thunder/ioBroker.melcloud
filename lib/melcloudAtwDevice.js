...
class MelcloudAtwDevice {
	...
	async UpdateDeviceData(deviceOption) {
		...
		await gthat.setStateChangedAsync(infoPrefix + commonDefines.AtwDeviceStateIDs.SetTemperatureZone1, this.setTemperatureZone1, true);
		if (this.hasZone2) await gthat.setStateChangedAsync(infoPrefix + commonDefines.AtwDeviceStateIDs.SetTemperatureZone2, this.setTemperatureZone2, true);
