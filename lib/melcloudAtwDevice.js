...
const operationModes = [commonDefines.AtwDeviceOperationModes.AUTO.id, commonDefines.AtwDeviceOperationModes.FORCEDHOTWATERMODE.id];
...
class MelcloudAtwDevice {
	...
	async buildPowerConsumptionReportRequestBody(isCumulatedReport = false) {
		...
		const endStateId = isCumulatedReport ? `${commonDefines.AdapterDatapointIDs.Reports}.${commonDefines.CommonDeviceStateIDs.PowerConsumptionReportEndDate}` : `${commonDefines.AdapterDatapointIDs.Devices}.${this.id}.${commonDefines.AdapterDatapointIDs.Reports}.${commonDefines.AtwDeviceStateIDs.PowerConsumptionReportEndDate}`;
