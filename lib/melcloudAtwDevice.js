...
class MelcloudAtwDevice {
	...
	async CreateAndSave() {
		...
		await gthat.extendObjectAsync(infoPrefix + commonDefines.AdapterStateIDs.OutdoorTemperature, {
			type: "state",
			common: {
		...
		await gthat.extendObjectAsync(infoPrefix + commonDefines.AdapterStateIDs.FlowTemperature, {
			type: "state",
			common: {
		...
		await gthat.extendObjectAsync(infoPrefix + commonDefines.AdapterStateIDs.FlowTemperatureZone1, {
			type: "state",
			common: {
		...
		await gthat.extendObjectAsync(infoPrefix + commonDefines.AdapterStateIDs.FlowTemperatureZone2, {
			type: "state",
			common: {
				name: "Flow temperature zone 1",
				type: "number",
		...
		await gthat.extendObjectAsync(infoPrefix + commonDefines.AdapterStateIDs.FlowTemperatureBoiler, {
			type: "state",
			common: {
		...
		await gthat.extendObjectAsync(infoPrefix + commonDefines.AdapterStateIDs.ReturnTemperature, {
			type: "state",
			common: {
		...
		await gthat.extendObjectAsync(infoPrefix + commonDefines.AdapterStateIDs.ReturnTemperatureZone1, {
			type: "state",
			common: {
		...
		await gthat.extendObjectAsync(infoPrefix + commonDefines.AdapterStateIDs.ReturnTemperatureZone2, {
			type: "state",
			common: {
		...
		await gthat.extendObjectAsync(infoPrefix + commonDefines.AdapterStateIDs.ReturnTemperatureBoiler, {
			type: "state",
			common: {
		...
		await gthat.extendObjectAsync(infoPrefix + commonDefines.AdapterStateIDs.TankWaterTemperature, {
			type: "state",
			common: {
	...
	async UpdateDeviceData(deviceOption = null) {
		...
		await gthat.setStateChangedAsync(infoPrefix + commonDefines.AdapterStateIDs.OutdoorTemperature, this.outdoorTemperature, true);
		await gthat.setStateChangedAsync(infoPrefix + commonDefines.AdapterStateIDs.FlowTemperature, this.flowTemperature, true);
		await gthat.setStateChangedAsync(infoPrefix + commonDefines.AdapterStateIDs.FlowTemperatureZone1, this.flowTemperatureZone1, true);
		await gthat.setStateChangedAsync(infoPrefix + commonDefines.AdapterStateIDs.FlowTemperatureZone2, this.flowTemperatureZone2, true);
		await gthat.setStateChangedAsync(infoPrefix + commonDefines.AdapterStateIDs.FlowTemperatureBoiler, this.flowTemperatureBoiler, true);
		await gthat.setStateChangedAsync(infoPrefix + commonDefines.AdapterStateIDs.ReturnTemperature, this.returnTemperature, true);
		await gthat.setStateChangedAsync(infoPrefix + commonDefines.AdapterStateIDs.ReturnTemperatureZone1, this.returnTemperatureZone1, true);
		await gthat.setStateChangedAsync(infoPrefix + commonDefines.AdapterStateIDs.ReturnTemperatureZone2, this.ReturnTemperatureZone2, true);
		await gthat.setStateChangedAsync(infoPrefix + commonDefines.AdapterStateIDs.ReturnTemperatureBoiler, this.returnTemperatureBoiler, true);
		await gthat.setStateChangedAsync(infoPrefix + commonDefines.AdapterStateIDs.TankWaterTemperature, this.tankWaterTemperature, true);
