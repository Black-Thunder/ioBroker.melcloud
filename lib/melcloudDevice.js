...
class MelcloudDevice {
	...
	async CreateAndSave() {
		...
		// Extend existing object to ensure compability with js-controller >= v3.2
		await gthat.extendObject(infoPrefix + commonDefines.AdapterStateIDs.LastCommunication, {
			common: {
				type: "string"
			}
		});
		...
		// Extend existing object to ensure compability with js-controller >= v3.2
		await gthat.extendObject(infoPrefix + commonDefines.AdapterStateIDs.NextCommunication, {
			common: {
				type: "string"
			}
		});
