...
class MelcloudAtaDevice {
	...
	async UpdateReportData() {
		...
		await gthat.setStateChangedAsync(reportsPrefix + commonDefines.AtaDeviceStateIDs.ReportedMonths, JSON.stringify(this.powerConsumptionReportMonths), true);
		let counter = 0;
		this.powerConsumptionReportMonths.forEach(month => {
			...
			if (this.canCool) gthat.setStateChangedAsync(reportsPrefix + commonDefines.AtaDeviceStateIDs.TotalPowerConsumptionPrefix + commonDefines.AtaDeviceOperationModes.COOL.id + monthName, commonDefines.roundValue(this.monthlyPowerConsumptionCooling[counter], 3), true);
			if (this.canHeat) gthat.setStateChangedAsync(reportsPrefix + commonDefines.AtaDeviceStateIDs.TotalPowerConsumptionPrefix + commonDefines.AtaDeviceOperationModes.HEAT.id + monthName, commonDefines.roundValue(this.monthlyPowerConsumptionHeating[counter], 3), true);
			...
			if (this.canDry) gthat.setStateChangedAsync(reportsPrefix + commonDefines.AtaDeviceStateIDs.TotalPowerConsumptionPrefix + commonDefines.AtaDeviceOperationModes.DRY.id + monthName, commonDefines.roundValue(this.monthlyPowerConsumptionDry[counter], 3), true);
		...
		if (this.canCool) await gthat.setStateChangedAsync(reportsPrefix + commonDefines.AtaDeviceStateIDs.TotalPowerConsumptionPrefix + commonDefines.AtaDeviceOperationModes.COOL.id, commonDefines.roundValue(this.totalPowerConsumptionCooling, 3), true);
		if (this.canHeat) await gthat.setStateChangedAsync(reportsPrefix + commonDefines.AtaDeviceStateIDs.TotalPowerConsumptionPrefix + commonDefines.AtaDeviceOperationModes.HEAT.id, commonDefines.roundValue(this.totalPowerConsumptionHeating, 3), true);
		...
		if (this.canDry) await gthat.setStateChangedAsync(reportsPrefix + commonDefines.AtaDeviceStateIDs.TotalPowerConsumptionPrefix + commonDefines.AtaDeviceOperationModes.DRY.id, commonDefines.roundValue(this.totalPowerConsumptionDry, 3), true);
